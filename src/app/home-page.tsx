          ...
          <div className="grid md:grid-cols-3 gap-6 mt-12 mb-16">
            <div className="bg-white/5 rounded-2xl p-8 border border-white/10 hover:bg-white/10 transition-colors group">
              ...
              <p className="text-gray-300 leading-relaxed text-sm">
                As a <strong>Senior Software Engineer</strong> with over 6 years of expertise, I specialize in engineering high-performance ecosystems across <strong>Android, Android TV, and Flutter</strong>. My architectural approach leverages <strong>MVVM, Jetpack Compose, and BLoC/Flow</strong> to build scalable products.
              </p>
            </div>

            <div className="bg-white/5 rounded-2xl p-8 border border-white/10 hover:bg-white/10 transition-colors group">
              <div className="flex items-center gap-4 mb-6">
                <div className="w-12 h-12 bg-gradient-to-br from-indigo-400 to-purple-500 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform">
                  <GraduationCap className="w-6 h-6 text-white" />
                </div>
                <h3 className="text-2xl font-semibold text-white">Education</h3>
              </div>
              <p className="text-gray-300 leading-relaxed text-sm">
                I hold a <strong>BS in Computer Science (3.8/4.0)</strong>, providing a rigorous foundation. My background is bolstered by industry credentials, including <strong>HackerRank Software Engineer Certification</strong> and <strong>Google Digital Garage</strong> certification.
              </p>
            </div>
            ...
            <div className="bg-white/5 rounded-2xl p-8 border border-white/10 hover:bg-white/10 transition-colors group">
              ...
              <p className="text-gray-300 leading-relaxed text-sm">
                When I’m not coding, I am an explorer of digital and physical worlds. I have a passion for <strong>gaming</strong> and the outdoors, where I enjoy <strong>hiking</strong> through trails. I bring this spirit of adventure to my <strong>mobile engineering</strong> work.
              </p>
            </div>
          </div>

          <ExpandableJourney data={siteData.timeline} />
