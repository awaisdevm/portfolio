...
export async function POST(request: Request) {
  try {
    ...
    // --- EMAIL 1: To You (The Admin Notification) ---
    ...
    // --- EMAIL 2: To the User (Auto Confirmation) ---
    resend.emails
      .send({
        from: fromEmail,
        to: email,
        ...
        `,
        text: `Hi ${name},\n\nThanks for reaching out! I've received your message and will reply within 1 business day.\n\nFor reference, here is what you sent:\n${message}\n\nBest regards,\n${siteConfig.name}`,
      })
