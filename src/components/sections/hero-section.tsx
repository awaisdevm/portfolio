    ...
    >
      ...
      >
        ...
        <div className="flex flex-col space-y-10 lg:col-span-7 order-2 lg:order-1 text-center lg:text-left">
          ...
          {/* Call To Actions */}
          <m.div variants={systemInitVariants} className="flex flex-col sm:flex-row gap-5 justify-center lg:justify-start pt-4">
            <Button
          ...
          {/* Quick Stats */}
          <m.div variants={systemInitVariants} className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-6 pt-8 opacity-90">
