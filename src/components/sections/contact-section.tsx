        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="grid lg:grid-cols-12 gap-8 items-stretch">
            ...
            <motion.div
              ...
              className="lg:col-span-5 p-8 sm:p-12 bg-blue-500/5 backdrop-blur-3xl border border-blue-500/20 rounded-[2rem] relative overflow-hidden group flex flex-col justify-between"
            >

              <div>
                <motion.div
                  className="w-16 h-16 bg-blue-500/10 border border-blue-500/30 rounded-2xl flex items-center justify-center mb-10 group-hover:scale-110 transition-transform duration-500 shadow-[0_0_20px_rgba(59,130,246,0.2)]"
                >
            ...
            <div className="lg:col-span-7 grid gap-4">
              {contactOptions.map(({ icon: Icon, label, value = "", color, glow, meta }) => (
                <motion.a
                  ...
                  className={`group relative flex items-center p-6 bg-white/5 backdrop-blur-3xl border border-white/10 rounded-2xl transition-all duration-500 hover:border-blue-500/30 hover:bg-blue-500/5 hover:-translate-x-2 overflow-hidden`}
                >
                  {/* Energy Rail Animation */}
                  <motion.div
                    className="absolute top-0 left-0 w-1 h-full bg-blue-500/40 opacity-0 group-hover:opacity-100"
                    initial={{ height: 0 }}
                    whileHover={{ height: "100%" }}
                  />

                  <div className={`w-14 h-14 bg-black/30 backdrop-blur-md border border-white/10 rounded-xl flex items-center justify-center mr-6 group-hover:scale-110 group-hover:border-blue-500/40 transition-all duration-500 shadow-2xl ${glow}`}>
